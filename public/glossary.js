...
(function () {
  ...
  var TERMS = [
    ...
    { re: 'UDRs?|UD Records', title: 'UDR: Unidentified Driving Record', def: 'Driving captured while no driver was logged in. The rule requires these records to be surfaced so a driver can claim them or the carrier can investigate. More than 30 minutes of unassigned driving in 24 hours triggers a diagnostic flag.' },
